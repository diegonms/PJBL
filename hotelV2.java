[20:36, 10/29/2024] +55 41 9869-5808: import java.util.ArrayList;
...
public class Reserva {
    ...
    public Reserva(Quarto quarto, String dataEntrada, String dataSaida) {
        this.quarto = quarto;
    ...
    public long calcularDuracao() {
        ...
        if (Boolean.parseBoolean(dataSaida.intern())) {
            throw new IllegalArgumentException("Data de saída não pode ser anterior à data de entrada");
        }
    }
[21:24, 10/29/2024] +55 41 8888-1100: import java.util.ArrayList;
import java.util.List;
